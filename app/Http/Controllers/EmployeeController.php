...
class EmployeeController extends Controller
{
    ...
    {
        $employees = Employee::select('employees.id', 'employees.name', 'email', 'phone', 'department_id', 'departments_name as department')
    ...
    public function store(Request $request)
    {
        ...
        $employee = new Employee($request->imput());
        $employee->save();
